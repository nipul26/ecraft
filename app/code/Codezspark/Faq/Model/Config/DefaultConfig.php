...
namespace Codezspark\Faq\Model\Config;
...
class DefaultConfig
{
     ...
     * FAQ template files
     */
    public const FAQ_MAIN_TEMPLATE_FILE = 'Codezspark_Faq::faq_main.phtml';
    public const FAQ_AJAX_TEMPLATE_FILE = 'Codezspark_Faq::faq_ajax.phtml';
}
