...
define([
    ...
    $.widget('mage.editSellerProfile', {
        options: {
            backUrl: '',
            errorMessageForAllowedExtensions: $t('Invalid Image Extension. Allowed extensions are jpg, jpeg, png, gif'),
            errorMessageForlogoAllowedExtensions: $t('Invalid Image Extension. Allowed extensions are jpg, jpeg, png, gif'),
