...
class Notifications extends \Magento\Framework\View\Element\Template
{
     ...
     * @return array
     */
    public function getNotificationDetail($rowData)
    {
        $message = '';
        if (empty($rowData)) {
            return $message;
        }
        $date = $this->helperData->changeDateFormat($rowData['created_at']);
        if ($rowData['type'] == Notification::TYPE_PRODUCT) {
            ...
            $message =[
                "message" => $productNotificationDesc,
                "date" => $date
            ];
            ...
            $message =[
                "message" => __("Order #%1 is %2.", $id, $status),
                "date" => $date
            ];
            ...
            $message =[
                "message" => $transactionNotificationDesc,
                "date" => $date
            ];
            ...
            $message =[
                "message" => $reviewNotificationDesc,
                "date" => $date
            ];
        }
        return $message;
