...
class Logo extends \Magento\Backend\Block\Template
{
    ...
    public const MODULE_NAME = 'Webkul_Marketplace';

    public const EXPIRE_CONFIG_PATH = 'marketplace/webkul/logo_expire_time';

    public const LOGO_CONFIG_PATH = 'marketplace/webkul/logo';
