...
class Navigation extends \Magento\Framework\View\Element\Html\Link
{
     ...
     * @return string
     */
    public function getOrderNotificationTitle()
    {
    ...
    public function getOrderNotificationDesc($orderId)
    {
        ...
        $saleslistIds = [];
        $collectionSales = $this->saleslistModel->create()
                      ->getCollection()
    ...
    /**
     * Seller Transaction Details is used to get the Seller Transaction table data by Id
     *
     * @param  int $id
     * @return \Webkul\Marketplace\Model\Sellertransaction
     */
