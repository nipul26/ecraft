...
class Withdrawal extends \Magento\Framework\View\Element\Template
{
    ...
    public function getTotalSellerSale()
    {
        ...
        $totalAmount = $actualSellerAmount + $totalTaxAmount + $totalShippingAmount + $codCharges;
        $total = $totalAmount - $refundedShippingAmount;
        return $total;
    }
    ...
    public function getTotalSale()
    {
        ...
        $sellerTotal = $totalAmount + $totalTaxAmount + $totalShippingAmount + $codCharges;
        $sellerRefund = $refundedShippingAmount + $couponAmount;
        $total = $sellerTotal - $sellerRefund;
        return $total;
    }
