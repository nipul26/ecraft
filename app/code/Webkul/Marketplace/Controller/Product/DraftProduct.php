...
/**
 * Webkul Marketplace Draft Product Controller.
 */
class DraftProduct extends Action
{
    /**
    ...
    /**
     * Seller's draft product List page.
     *
    ...
    public function execute()
    {
        ...
        if ($isPartner == 1) {
            ...
            if ($helper->getIsSeparatePanel()) {
                $resultPage->addHandle('marketplace_layout2_draft_product_list');
            }
