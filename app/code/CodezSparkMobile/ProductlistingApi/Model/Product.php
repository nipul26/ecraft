...
class Product extends \Magento\Catalog\Model\AbstractModel implements
    IdentityInterface,
    SaleableInterface,
    \CodezSparkMobile\ProductlistingApi\Api\Data\ProductInterface
{
    /**
     ...
     * Get Product Badges
     *
     * @return \CodezSparkMobile\ProductlistingApi\Api\Data\ProductBadgesInterface[]|nul
    l     */
    public function getProductBadges()
    {
        return $this->_getData(self::PRODUCTBADGES);
    }
     ...
     * @return $this
     */
    public function setProductBadges(array $response)
    {
        return $this->setData(self::PRODUCTBADGES, $response);
    }
}
